...
typedef enum MessageType {
    ...
    BAND_PING = 3,						//From Band to PC --> starts up TCP connection from band listener
    ...
    LOW_BATTERY_UPDATE = 11,                         //From Band to PC --> Tells PC that band voltage is way low --> charge it  (LOW BATTERY!!!)
    ...
    VOICE_CONTROL_LOW_BATT = 15,                     //From Band to PC --> Gives PC voice control data from chestpiece  (LOW BATTERY!!!)
